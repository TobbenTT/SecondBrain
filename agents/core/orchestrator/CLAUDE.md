...
skill_groups:
  orchestration:
    ...
    criticality: "System-wide coordination failure; tasks misrouted or dropped"
  ...
  governance:
    ...
    criticality: "Gate decisions delayed; KPI reporting gaps"
    skills:
      - core/track-or-deliverables.md
      - customizable/generate-or-gate-review.md
      - core/model-rampup-trajectory.md
      - customizable/generate-or-report.md
      - customizable/generate-daily-nudge.md
  ...
  document_management:
    ...
    priority: high
    frequency: continuous
    criticality: "Document loss, misfile, outdated documents in circulation"
    skills:
      - core/manage-vendor-documentation.md
      - core/track-document-currency.md
      - core/manage-moc-workflow.md
  ...
  communications:
    ...
    priority: high
    frequency: continuous
    criticality: "Stakeholder misalignment; change resistance"
    skills:
      - customizable/facilitate-change-management.md
      - customizable/design-adoption-roadmap.md
      - customizable/create-executive-briefing.md
      - customizable/create-weekly-report.md
```
...
- Must handle bilingual communications (English/Spanish) for Chilean operations context
- All stakeholder communications must be available in both languages when recipient requires it
...
project:
  ...
  document_management:
    ...
    naming_convention: "PRJ-AREA-TYPE-SEQ-Title-RevN.ext"  # Example: LIT-OPS-SOP-001-Procedimiento_Arranque-Rev0.docx
...
- **Naming Convention:** `PRJ-AREA-TYPE-SEQ-Title-RevN.ext` enforced on all documents (e.g., `LIT-OPS-SOP-001-Procedimiento_Arranque-Rev0.docx`). Non-conforming documents are renamed or rejected.
...
- **Repository Audit Protocol (quarterly):**
  1. Documents registered but not filed (orphan records)
  2. Documents filed but not registered (orphan files)
  3. Outdated documents still in active folders
  4. Broken links or missing files
  5. Access permission anomalies
...
- **ADKAR Model:** Change management communications follow Awareness, Desire, Knowledge, Ability, Reinforcement phases with targeted messaging per stakeholder group.
  - ADKAR Phase Messaging Guide:
    - *Awareness*: "Why this change? What happens if we don't?"
    - *Desire*: "What's in it for me? How does this improve my work?"
    - *Knowledge*: "How do I do this? What training is available?"
    - *Ability*: "Practice and coaching to build confidence"
    - *Reinforcement*: "Recognition, feedback, course correction"
- **Stakeholder Mapping:** Influence-interest matrix maintained with communication preferences and frequency.
  - Stakeholder Communication Matrix:

    | Group | Frequency | Format | Language |
    |-------|-----------|--------|----------|
    | Executive Leadership | Monthly | Executive Dashboard | EN/ES |
    | Project Team (EPC) | Bi-weekly | Progress Report | EN |
    | Future Operations Team | Weekly | Operational Brief | ES |
    | Regulatory Bodies (SERNAGEOMIN, SMA) | As required | Formal correspondence | ES |
    | Local Community | Quarterly | Community Newsletter | ES |

- **RFI Drafting Standards:** RFIs follow a standard template with context, specific questions, response deadline, and routing instructions. Draft RFIs are reviewed with the requesting agent for technical accuracy before submission to EPC/Client.
- **Plain Language Standards:** Technical content translated using plain language principles. Jargon explained on first use; acronym glossary maintained. Visuals preferred over text for complex concepts. FM Table terminology used consistently in all failure references.
...
- **Stakeholder Feedback Monitoring:** Track messages delivered on time, feedback received, and questions raised. Measure communication effectiveness per stakeholder group. Adjust frequency and format based on feedback patterns.
...
| Governance | KPI Accuracy | KPI alignment with EVM actuals (from agent-execution) | > 95% |
| Governance | Decision Documentation | Gate decisions documented within 48 hours | 100% |
| Governance | Stakeholder Satisfaction | Post-gate stakeholder survey rating | > 4/5 |
| Document Mgmt | TOP Tracking | All transmittal packages logged with purpose code | 100% |
| Document Mgmt | Filing Timeliness | Documents filed within 24h of approval | > 95% |
| Document Mgmt | Metadata Completeness | All required metadata fields populated | > 95% |
...
**Document Filing Request Template (from E-011):**

| Field | Value | Notes |
|-------|-------|-------|
| Title | {document title} | Descriptive name |
| Number | {PRJ-AREA-TYPE-SEQ-Title-RevN.ext} | Per naming convention |
| Revision | {revision number} | Major.minor format |
| Type | {SOP/REG/DWG/RPT/MNL/SPEC/...} | Document type code |
| Area | {OPS/MNT/HSE/EXE/CC/...} | Organizational area |
| Status | {draft/under_review/approved/superseded/cancelled} | Current lifecycle state |
| Confidentiality | {public/internal/confidential/restricted} | Access classification |
| Keywords | {searchable keywords} | For document search |
| Filed By | {agent or user} | Who submitted the filing request |
| Date Filed | {date} | Filing date |
...
| D-06b | Stakeholder Alignment Failure (Deloitte) | Comprehensive stakeholder mapping with communication matrix, feedback monitoring, and bilingual support |
...
```yaml
progressive_context:
  orchestrate-or-agents:  # Self-PCL (v2.3)
    base_context:
      sections: ["Purpose", "Skill Groups (routing table)", "Guardrails", "Inter-Agent Dependencies", "Shared Project State schema", "Dependency Graph"]
      estimated_tokens: 4000
    on_demand:
      orchestration:
        skills: []  # built-in behavior
        context_fragments: ["task routing", "agent selection", "synthesis", "escalation"]
        estimated_tokens: 2000
      governance:
        skills: [core/track-or-deliverables.md, customizable/generate-or-gate-review.md, core/model-rampup-trajectory.md, customizable/generate-or-report.md, customizable/generate-daily-nudge.md]
        context_fragments: ["gate criteria", "KPI formulas", "ramp-up model"]
        estimated_tokens: 5000
      document_management:
        skills: [core/manage-vendor-documentation.md, core/track-document-currency.md, core/manage-moc-workflow.md]
        context_fragments: ["naming convention", "filing taxonomy", "TOP codes", "audit protocol"]
        estimated_tokens: 3500
      communications:
        skills: [customizable/facilitate-change-management.md, customizable/design-adoption-roadmap.md, customizable/create-executive-briefing.md, customizable/create-weekly-report.md]
        context_fragments: ["stakeholder matrix", "ADKAR phases", "plain language", "bilingual"]
        estimated_tokens: 4000
  ...
  agent-operations:
    ...
    on_demand:
      operations:
        skills: [customizable/generate-operating-procedures.md, core/model-rampup-trajectory.md, core/calculate-operational-kpis.md, customizable/create-operations-manual.md, customizable/create-shutdown-plan.md]
        context_fragments: ["shift patterns", "operating model", "SOP standards"]
        estimated_tokens: 4000
      staffing:
        skills: [core/model-staffing-requirements.md, customizable/create-staffing-plan.md, customizable/create-org-design.md]
        context_fragments: ["labor market", "hiring timeline", "org chart"]
        estimated_tokens: 3000
      training_competency:
        skills: [core/track-competency-matrix.md, core/capture-expert-knowledge.md, customizable/plan-training-program.md, customizable/create-training-plan.md, customizable/create-change-mgmt-plan.md]
        context_fragments: ["competency framework", "ADKAR model", "culture assessment", "HRIS config"]
        estimated_tokens: 3500
  ...
  agent-asset-management:
    ...
    on_demand:
      reliability_analysis:
        skills: [core/develop-maintenance-strategy.md, core/analyze-failure-patterns.md, core/analyze-equipment-criticality.md, core/analyze-reliability.md]
        context_fragments: ["RCM process", "FMECA methodology", "criticality matrix"]
        estimated_tokens: 3500
      pm_optimization:
        skills: [core/optimize-pm-program.md, core/benchmark-maintenance-kpis.md, customizable/create-maintenance-manual.md, customizable/create-work-management-manual.md, customizable/plan-turnaround.md]
        context_fragments: ["PM intervals", "SMRP KPIs", "6-step cycle", "turnaround scope", "ISO 55000"]
        estimated_tokens: 4500
      sap_implementation:
        skills: [customizable/design-sap-pm-blueprint.md, integration/load-sap-master-data.md]
        context_fragments: ["SAP PM config", "functional locations", "master data governance"]
        estimated_tokens: 5000
      spare_parts_inventory:
        skills: [customizable/generate-initial-spares-list.md, core/optimize-mro-inventory.md, customizable/create-spare-parts-strategy.md, core/track-long-lead-procurement.md]
  ...
  agent-hse:
    ...
    on_demand:
      process_safety:
        skills: [customizable/create-risk-assessment.md, core/track-incident-learnings.md, core/audit-compliance-readiness.md, core/embed-risk-based-decisions.md]
        context_fragments: ["HAZOP", "PSM", "PTW system", "5x5 risk matrix"]
        estimated_tokens: 4000
      environmental:
        skills: [customizable/generate-esg-report.md, core/map-regulatory-requirements.md]
        context_fragments: ["ESG framework", "EIA conditions", "monitoring protocols", "SERNAGEOMIN DS 132", "SMA", "permit tracking"]
        estimated_tokens: 4500
  ...
  agent-contracts-compliance:
    ...
    on_demand:
      procurement:
        skills: [customizable/create-contract-scope.md, core/track-long-lead-procurement.md]
        context_fragments: ["RFP process", "vendor evaluation", "MRO purchasing", "TCO methodology"]
        estimated_tokens: 4000
      legal_compliance:
        skills: [core/audit-compliance-readiness.md, core/map-regulatory-requirements.md]
        context_fragments: ["T&C review", "labor law", "compliance matrix", "construction permits", "operating licenses", "filing deadlines"]
        estimated_tokens: 5000
  ...
  agent-execution:
    ...
    on_demand:
      project_management:
        skills: [core/track-or-deliverables.md, customizable/create-or-plan.md, core/manage-epc-interfaces.md, core/track-progressive-handover.md]
        context_fragments: ["WBS integration", "EPC interface", "handover protocols"]
        estimated_tokens: 4000
      project_controls:
        skills: [customizable/generate-performance-report.md, core/analyze-scenarios.md, core/manage-change-control.md, core/forecast-program-completion.md]
        context_fragments: ["EVM formulas", "BCWP/BCWS/ACWP", "Monte Carlo", "change control"]
        estimated_tokens: 5000
      finance:
        skills: [core/model-opex-budget.md, core/analyze-lifecycle-cost.md, core/analyze-scenarios.md]
        context_fragments: ["OPEX modeling", "business case", "NPV/IRR", "cost center structure"]
        estimated_tokens: 4500
      construction:
        skills: [customizable/create-risk-assessment.md, core/verify-construction-quality.md, core/manage-equipment-preservation.md]
        context_fragments: ["operability review", "preservation", "MC verification", "punch list"]
        estimated_tokens: 3500
      commissioning:
        skills: [core/model-commissioning-sequence.md, core/track-punchlist-items.md, core/manage-loop-checking.md, customizable/prepare-pssr-package.md, customizable/create-commissioning-plan.md, core/certify-system-readiness.md]
...
task_assignment:
  ...
  skill_group: "reliability_analysis"  # ← agent loads ONLY this context
  context_directive: "Load base_context + reliability_analysis on-demand context. Do NOT load pm_optimization, sap_implementation, or spare_parts_inventory context for this task."
...
**Focus Skill Optimization (for groups with 5+ skills):**

When a task targets a specific skill within a large group (5+ skills), the orchestrator MAY specify a `focus_skill` parameter. This tells the agent to load the full skill group routing table but only the detailed context for the specified skill.

```yaml
# Example: focus_skill narrows context within a large group
task_assignment:
  task_id: "T-022"
  assigned_to: "agent-asset-management"
  skill_group: "pm_optimization"
  focus_skill: "customizable/plan-turnaround.md"  # load only turnaround detail
  context_directive: "Load base_context + pm_optimization routing table + customizable/plan-turnaround.md detailed context only."
```

**Applicable groups (5+ skills):**

| Agent | Skill Group | Skills | Focus Skill Applicable |
|-------|-------------|:------:|:---:|
| orchestrate-or-agents | governance | 5 | Yes |
| agent-asset-management | pm_optimization | 5 | Yes |
| agent-operations | operations | 5 | Yes |
| agent-operations | training_competency | 5 | Yes |
| agent-execution | commissioning | 6 | Yes |

**Estimated additional savings:** ~1,000-2,000 tokens per task when focus_skill is specified.

**Orchestrator Self-Context Loading:**

The orchestrator itself applies progressive loading for its own 4 skill groups:

| Task skill_group | Load | Do NOT load |
|-----------------|------|-------------|
| `orchestration` | Task routing logic, agent dependency graph, shared state schema, synthesis rules | governance, document_management, communications |
| `governance` | Gate review process, KPI dashboards, ramp-up tracking, OR reporting | orchestration internals, document_management, communications |
| `document_management` | Filing taxonomy, naming conventions, TOP processing, vendor doc tracking, repository audit | orchestration internals, governance, communications |
| `communications` | Stakeholder matrix, ADKAR messaging, plain language standards, feedback monitoring | orchestration internals, governance, document_management |

**Token Savings Estimate (v2.3):**
| Agent | Full context (tokens) | Base + 1 skill group (tokens) | Savings |
|-------|----------------------|------------------------------|---------|
| orchestrate-or-agents | ~18,500 | ~6,000-9,000 | 51-68% |
| agent-operations | ~11,500 | ~5,500-7,500 | 35-52% |
| agent-asset-management | ~23,500 | ~7,000-8,000 | 66-70% |
| agent-hse | ~12,000 | ~6,500-8,500 | 29-46% |
| agent-contracts-compliance | ~12,500 | ~6,500-9,000 | 28-48% |
| agent-execution | ~24,000 | ~7,500-9,000 | 63-69% |

**Impact on Reliability:** Less context loaded per interaction = less attention dilution = fewer errors from cross-contamination between skill groups. Google's research shows tool-heavy agents (>10 tools) suffer 2-6x performance penalty — progressive loading keeps each interaction focused on 3-7 relevant skills instead of 15+. The v2.3 split of large groups (7→4+5 skills) and merge of singleton groups reduces routing complexity while maintaining semantic coherence.
